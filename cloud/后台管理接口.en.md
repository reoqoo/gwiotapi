...
noticeStatus     |int    | Yes |message notice status, 0: no, 1: yes
...
subTime         |int64  | Yes |Subscription time, 0: not subscribed
withholdTime         |int64  | Yes |Latest deduction time, 0: no deduction
usedData |int64 |Yes |Total historical data consumption (Unit: MB)
activeRegion |string |Yes |Activation region (empty if not activated)
iccids |array |Yes |List of historical ICCIDs associated with the device

**iccids array object structure**：
Parameter Name       |Type    |Required|Description
---------------------|--------|--------|----
deviceId | string | Yes | Device ID
iccid | string | Yes | Specific ICCID number
