...
noticeStatus         |int  | 是 | 消息通知状态，0：不通知，1：通知
...
subTime         |int64  | 是 | 订阅时间，0：未订阅
withholdTime         |int64  | 是 | 最近一次扣款时间， 0：未扣款
usedData    |int64  |是    |历史消耗流量总量（单位：MB）
activeRegion |string |是 |激活地区，为空表示未激活
iccids    |array |是  |设备关联的历史ICCID列表
